...
export default function UpdatePost() {
  ...
  return (
    <div className="min-h-screen max-w-3xl mx-auto p-3 mb-16">
        <h3 className="text-3xl font-semibold text-center my-7">Update post</h3>
        <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
          ...
          <ReactQuill theme='snow' placeholder='Write about your post...' id='content' value={formData.content}

    ...
    const handleDeletePost = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                // filter returns an array so no need to set userPosts
                // inside the array like setUserPosts([userPost.fileter()])
            } else {
                                ...
                                <Table.Cell>
                                    <Link to={`/post/${post.slug}`}>
                                        <img src={post.image} alt={post.title}
                                            className="h-10 object-cover bg-gray-500 rounded-sm"/>
                                    </Link>
                                </Table.Cell>
                                <Table.Cell>
                                    <Link to={`/post/${post.slug}`} className="font-medium text-gray-800
                                    dark:text-gray-200">
                                        {post.title}
                                    </Link>
                                </Table.Cell>
